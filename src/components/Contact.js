...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action='https://getform.io/f/1048d435-c4b3-474a-b79d-6af9308473d2' className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
            ...
            <button className='text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 my-8 mx-auto flex items-center rounded-md'>Send</button>
        </form>
    </div>
  )
}
